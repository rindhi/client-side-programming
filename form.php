            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-primary" onclick="tampil()" id="btn1">Tampilkan</button>
                            <button type="button" class="btn btn-danger" onclick="kosong()" id="btn2">Reset</button>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    function tampil() {
        let tgl = $("#txttgllahir").val();
        if (tgl == "") {
            swal("Kesalahan", "Tanggal Lahir Belum Diisi", {
                icon: "error"
            });
            return;
        }
